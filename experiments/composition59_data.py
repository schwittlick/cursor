...
data_map[yellow][neon_green] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{yellow}\\{neon_green}\\1111.jpg",
}
...
data_map[blue][yellow] = {
    "created": "02.03.2021",
    "objktid": 1111,
    "file": f"{path}{blue}\\{yellow}\\20210303_8.jpg",
}
...
data_map[blue][green] = {
    "created": "17.03.2021",
    "objktid": 1111,
    "file": f"{path}{blue}\\{green}\\20211012.jpg",
}
...
data_map[blue][magenta] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{blue}\\{magenta}\\1111.jpg",
}
...
data_map[blue][neon_orange] = {
    "created": "16.06.2021",
    "objktid": 1111,
    "file": f"{path}{blue}\\{neon_orange}\\20210622.jpg",
}
...
data_map[green][yellow] = {
    "created": "29.02.2021",
    "objktid": 530222,
    "file": f"{path}{green}\\{yellow}\\20211111_1_gy.jpg",
}
...
data_map[green][neon_yellow] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{green}\\{neon_yellow}\\1111.jpg",
}

data_map[green][neon_orange] = {
    "created": "19.03.2021",
    "objktid": 1111,
    "file": f"{path}{green}\\{neon_orange}\\20210320.jpg",
}
...
data_map[red][yellow] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{red}\\{yellow}\\1111.jpg",
}

data_map[red][blue] = {
    "created": "20.06.2021",
    "objktid": 1111,
    "file": f"{path}{red}\\{blue}\\20210622_rb.jpg",
}
...
data_map[red][violet] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{red}\\{violet}\\1111.jpg",
}
...
data_map[red][neon_orange] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{red}\\{neon_orange}\\1111.jpg",
}
...
data_map[orange][blue] = {
    "created": "10.03.2021",
    "objktid": 1111,
    "file": f"{path}{orange}\\{blue}\\20210320_17.jpg",
}
...
data_map[orange][violet] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{orange}\\{violet}\\1111.jpg",
}
...
data_map[black][yellow] = {
    "created": "17.06.2021",
    "objktid": 1111,
    "file": f"{path}{black}\\{yellow}\\20210622_by.jpg",
}
...
data_map[black][black] = {
    "created": "09.08.2020",
    "objktid": 1111,
    "file": f"{path}{black}\\{black}\\20200908_23.jpg",
}
...
data_map[black][violet] = {
    "created": "27.03.2021",
    "objktid": 1111,
    "file": f"{path}{black}\\{violet}\\20210327_3.jpg",
}
...
data_map[white][neon_green] = {
    "created": "1111",
    "objktid": 1111,
    "file": f"{path}{white}\\{neon_green}\\1111.jpg",
}
...
data_map[violet][red] = {
    "created": "18.11.2021",
    "objktid": 1111,
    "file": f"{path}{violet}\\{red}\\20211125_4_vr.jpg",
}
...
data_map[magenta][yellow] = {
    "created": "06.02.2021",
    "objktid": 1075,
    "file": f"{path}{magenta}\\{yellow}\\20210213.jpg",
}
...
data_map[magenta][neon_green] = {
    "created": "08.03.2021",
    "objktid": 1111,
    "file": f"{path}{magenta}\\{neon_green}\\20210320_10.jpg",
}
...
data_map[neon_yellow][yellow] = {
    "created": "09.02.2021",
    "objktid": 1111,
    "file": f"{path}{neon_yellow}\\{yellow}\\20210213_9.jpg",
}
...
data_map[neon_yellow][neon_green] = {
    "created": "02.02.2022",
    "objktid": 1111,
    "file": f"{path}{neon_yellow}\\{neon_green}\\1111.jpg",
}
