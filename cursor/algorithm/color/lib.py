...
def create_legend_path(x: float, y: float, layer_index: int, pen_index: int, path_color: Color, radius: float) -> Path:
            ...
            if wtf:
                ...
                if all_corners:
                    ...
                    if absolute:
                        ...
                        if legende_x:
                            x = collection_bb.x2 + absolute_offset[
                                0] + pen_index * legende_scale  # left side for legende
                        else:
                            x = collection_bb.x - absolute_offset[
                                0] + pen_index * legende_scale  # legende on right side
                        if legende_y:
