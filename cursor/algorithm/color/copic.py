...
class Color:
    ...
    @staticmethod
    def blues() -> list[ColorCode]:
        return [ColorCode.B0000, ColorCode.B000, ColorCode.B00, ColorCode.B01, ColorCode.B02, ColorCode.B04,
                ColorCode.B05, ColorCode.B06, ColorCode.B12, ColorCode.B14, ColorCode.B16, ColorCode.B18, ColorCode.B21,
                ColorCode.B23, ColorCode.B24, ColorCode.B26, ColorCode.B28, ColorCode.B29, ColorCode.B34, ColorCode.B37,
                ColorCode.B39, ColorCode.B41, ColorCode.B45, ColorCode.B52, ColorCode.B60, ColorCode.B63, ColorCode.B66,
                ColorCode.B69, ColorCode.B79, ColorCode.B91, ColorCode.B93, ColorCode.B95, ColorCode.B97, ColorCode.B99]
...
class Copic:
    def __init__(self):
        ...
        # ----
        #self.colors[ColorCode.B0000] = CopicColor(ColorCode.B0000, "Pale Celestine", (240, 249, 254))
        #self.colors[ColorCode.B000] = CopicColor(ColorCode.B000, "Pale Porcelain Blue", (230, 244, 245))
        #self.colors[ColorCode.B00] = CopicColor(ColorCode.B00, "Frost Blue", (221, 240, 244))
        #self.colors[ColorCode.B01] = CopicColor(ColorCode.B01, "Mint Blue", (214, 238, 242))
        #self.colors[ColorCode.B02] = CopicColor(ColorCode.B02, "Robin's Egg Blue", (179,227,241))
