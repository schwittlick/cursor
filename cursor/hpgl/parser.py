...
class HPGLParser:
    def __init__(self):
        ...
        self.func_map = {
            IN: self.__init,
            SP: self.__parse_pen_select,
            PA: self.__parse_pen_absolute,
            LB: self.__parse_label,
            SI: self.__parse_font_size,
            PD: self.__parse_pen_down,
...
stick_font = {
    ...
    "g": [
        [(3.5, 6.0), (3.5, 0.0), (3.375, -1.0), (3.0, -1.75), (2.375, -2.0), (1.0, -2.0), (0.25, -1.5)],
        [
            (3.5, 4.0),
            (3.375, 5.0),
            (3.0, 5.75),
    ...
    "Ó": [
        [(0.0, 0.0), (1.75, 8.0), (4.0, 8.0), (4.0, 8.0)],
        [(2.175, 8.0), (2.175, 0.0), (4.0, 0.0)],
        [(0.975, 4.0), (4.0, 4.0)],
    ],
    ...
    "ó": [
        ...
        [(3.0, 2.0), (3.0, 1.0), (3.125, 0.25), (3.375, 0.0), (3.75, 0.25), (4.0, 1.25)],
    ],
    "ô": [
        [(2.125, 8.0), (2.125, 0.0)],
        [(3.25, 8.0), (3.25, 0.0)],
